...
def main(trim_path, bowtie_path, picard_path, gatk_path,
    ...
    tcmd = ['/home/basespace/ahcg_pipeline/noupload/jre1.8.0_101/bin/java', '-jar', trim_path, 'PE', '-phred33', read1, read2, tread1,
    ...
    acmd = ['/home/basespace/ahcg_pipeline/noupload/jre1.8.0_101/bin/java', '-Xmx1g', '-jar', picard_path, 'AddOrReplaceReadGroups',
    ...
    mdcmd = ['/home/basespace/ahcg_pipeline/noupload/jre1.8.0_101/bin/java', '-Xmx1g', '-jar', picard_path, 'MarkDuplicates', 'I='+add_path, 
    ...
    fcmd = ['/home/basespace/ahcg_pipeline/noupload/jre1.8.0_101/bin/java', '-Xmx1g', '-jar', picard_path, 'FixMateInformation',
    ...
    trcmd = ['/home/basespace/ahcg_pipeline/noupload/jre1.8.0_101/bin/java', '-jar', gatk_path, '-T', 'RealignerTargetCreator', '-o',
    ...
    recmd = ['/home/basespace/ahcg_pipeline/noupload/jre1.8.0_101/bin/java', '-jar', gatk_path, '-T', 'IndelRealigner',
    ...
    bqscmd = ['/home/basespace/ahcg_pipeline/noupload/jre1.8.0_101/bin/java', '-jar', gatk_path, '-T', 'BaseRecalibrator', '-R', ref_path,
    ...
    prcmd = ['/home/basespace/ahcg_pipeline/noupload/jre1.8.0_101/bin/java', '-jar', gatk_path, '-T', 'PrintReads', '-R', ref_path, '-I',
    ...
    hcmd = ['/home/basespace/ahcg_pipeline/noupload/jre1.8.0_101/bin/java', '-jar', gatk_path, '-T', 'HaplotypeCaller', '-R', ref_path,
